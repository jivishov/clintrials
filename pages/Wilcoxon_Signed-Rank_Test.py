...
st.title("Wilcoxon Signed-Rank Test Calculator")
...
if uploaded_file is not None:
    ...
    # Select columns
    selected_columns = st.multiselect("Select two columns for Wilcoxon Signed-Rank Test", df.columns.tolist())
    ...
    if len(selected_columns) == 2:
        ...
        w_stat, p_value = wilcoxon(col1_data, col2_data)
